# (Integração Sistêmica do Marco Legal de CT&I e as ICTs)
...
- **Acordo de Parceria para PD&I (Art. 9º)**: Destinado a atividades que envolvam risco tecnológico e busca por novos conhecimentos ou tecnologias (obrigação de meio). Exige estipulação prévia sobre cotitularidade de Propriedade Intelectual (PI), permite o pagamento de Bolsas de Estímulo e goza de dispensa de licitação expressa.
    
- **Prestação de Serviços Técnicos Especializados (Art. 8º)**: Voltado para a aplicação de conhecimento e infraestrutura preexistentes (testes, ensaios, consultorias de prateleira), configurando obrigação de resultado. Não há geração de nova PI e a remuneração da equipe técnica ocorre obrigatoriamente por Adicional Variável, sendo vedado o uso de bolsas.
...
- **Fundations de Apoio Atuando como ICTs**: O Guia de Caracterização alerta que se uma Fundação de Apoio desejar atuar como uma ICT privada autônoma em determinado projeto, ela deve demonstrar em seus estatutos e na prática uma estrutura segregada de pesquisa, sob pena de desvio de finalidade.
